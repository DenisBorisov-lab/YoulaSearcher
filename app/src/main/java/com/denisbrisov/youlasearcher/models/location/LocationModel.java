package com.denisbrisov.youlasearcher.models.location;
...
public class LocationModel {
    ...
    @JsonProperty("citySlug")
    public void setCitySlug(String value) {
        this.citySlug = value;
    }

    @JsonProperty("cityLocation")
    public boolean getCityLocation() {
        return cityLocation;
    }

    @JsonProperty("cityLocation")
    public void setCityLocation(boolean value) {
        this.cityLocation = value;
    }

    @JsonProperty("pointLocation")
    public boolean getPointLocation() {
        return pointLocation;
    }

    @JsonProperty("pointLocation")
    public void setPointLocation(boolean value) {
        this.pointLocation = value;
    }

    @JsonProperty("defaultRadius")
    public boolean getDefaultRadius() {
        return defaultRadius;
    }

    @JsonProperty("defaultRadius")
    public void setDefaultRadius(boolean value) {
