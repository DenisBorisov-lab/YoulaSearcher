...
// Import this package:
//
//     import com.denisbrisov.youlasearcher.models.response.Converter;
//
// Then you can deserialize a JSON string with
//
//     YoulaResponse data = Converter.fromJsonString(jsonString);
...
public class Converter {
    ...
    public static YoulaResponse fromJsonString(String json) throws IOException {
        return getObjectReader().readValue(json);
    }

    public static String toJsonString(YoulaResponse obj) throws JsonProcessingException {
    ...
    private static void instantiateMapper() {
        ...
        reader = mapper.readerFor(YoulaResponse.class);
        writer = mapper.writerFor(YoulaResponse.class);
    }
